//
//  RuPersonCollectionViewCell.swift
//  Borodino
//
...
class RuPersonCollectionViewCell: UICollectionViewCell, ConfiguringCell {
    
    static var resuedId = K.ruPersonIDCell
...
extension RuPersonCollectionViewCell {
